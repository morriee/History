...
public class Corona1 extends JFrame implements ItemListener {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	String A[]={"China","Italy","USA","Spain","Germany","Iran","France","S.Korea","Switzerland","UK",
            "Netherlands","Austria","Belgium","Norway","Portugal","Sweden","Australia","Brazil","Malaysia","Canada",
            "Denmark","Israel","Turkey","Czechia","Japan"};
	boolean ap[];
	Checkbox As[];
...
g.drawString("Corona cases",700,700);
g.drawString("Corona Deaths",100,100);
